...
def submit_guess(event=None):
    ...
    try:
        ...
        if guess < num:
            ...
            reset = True
            # Khóa nhập cho ván hiện tại, bật nút Reset
...
label = ttk.Label(frame, text="Guess a number between 1 and 100")
...
result.grid(row=2, column=0, columnspan=3, pady=(10, 6))

# Tạo sẵn nút Reset, để disabled cho đến khi đoán đúng
reset_btn = ttk.Button(frame, text="Reset Game",
                       command=reset_game, state="disabled")
